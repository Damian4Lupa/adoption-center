...
const HowWeHelp = () => {
    ...
    return (
        <>
            ...
            <section class="showcase">
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 order-lg-2 text-white showcase-img test"></div>

                        <div class="col-6 order-lg-1 my-auto showcase-text">
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-6 text-white showcase-img test"></div>
            ...
            <section class="team text-center bg-light">
                <Container>
                    <h2 class="mb-5">Our team</h2>
                    <Row>
                        <div class="col">
                            <div class="team-item mx-auto mb-5 mb-lg-0">
                                <img class="img-fluid rounded-circle mb-3" src={testFoto} alt="" />
                                <h5>Margaret E.</h5>
